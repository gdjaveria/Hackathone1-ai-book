# hackathone Development Guidelines

Auto-generated from all feature plans. Last updated: 2025-12-09

## Active Technologies
- Python 3.11 (for robotics code examples using ROS 2 `rclpy`), TypeScript/JavaScript (for Docusaurus configuration and potential interactive components). + ROS 2 Humble/Iron (`rclpy`), Docusaurus, Gazebo, Unity. (001-digital-twin-module)
...
- Python 3.11+ (003-qdrant-vector-storage)
- Qdrant Cloud (for initial implementation), with local Docker setup. (003-qdrant-vector-storage)
...
## Recent Changes
- 003-qdrant-vector-storage: Added Python 3.11+
